...
widget_defaults = dict(font="FiraMono",margin=0, borderwidth=0, fontsize=18, linewidth=0, padding=15, background=panel_color)
...
def init_screens():
    return [
            Screen(top=bar.Bar(widgets=init_widgets_screen1(), opacity=1, size=50)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), opacity=1, size=50)),
            Screen(top=bar.Bar(widgets=init_widgets_screen3(), opacity=1, size=50)),
            ]
