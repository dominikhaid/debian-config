...
def init_screens():
    return [
            Screen(top=bar.Bar(widgets=init_widgets_screen1(), opacity=1, size=35)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), opacity=1, size=35)),
            Screen(top=bar.Bar(widgets=init_widgets_screen3(), opacity=1, size=25)),
            ]
